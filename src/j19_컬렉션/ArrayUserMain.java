...
public class ArrayUserMain {
	...
	public static void main(String[] args) {
		...
		User[] userArray = { // User를 담을수있는 배열 0 1 2 3까지 들어가있음
				new User("aaa", "김종환"), new User("bbb", "고병수"), new User("ccc", "손민재"), new User("ddd", "황창욱"), };
		...
		/*
		 * 검색성공! aaa계정의 회원 이름은 김종환입니다. 검색실패! 존재하지 않는 계정입니다.
		 */
